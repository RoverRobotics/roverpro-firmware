...
REM set /P svn_revision="Enter SVN revision number: "
	...
	copy firmware.hex releases\"%date_name%_%time_name%"\Motor_Controller_compiled_!year_string!_!month_string!_!day_string!_time_!hour_string!_!minute_string!_(%date_name_short%.%time_name_short%).hex
