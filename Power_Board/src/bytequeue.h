...
/// If the ByteQueue has at least n bytes of data, remove them from the ByteQueue and write them to
/// data_out. Otherwise, the ByteQueue and data_out is unmodified. It is safe to call bq_try_push
/// and bq_try_pop concurrently.
/// @param self the ByteQueue to operate on
/// @param n the number of bytes to retrieve
/// @param data_out where resulting data will be written. If unsuccessful, contents will be
/// unchanged.
