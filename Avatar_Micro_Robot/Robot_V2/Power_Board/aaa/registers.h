...
REGISTER_START()
   ...
   REGISTER( REG_JOYSTICK1_X,         DEVICE_READ,  DEVICE_OCU,     SYNC,    float )
   REGISTER( REG_JOYSTICK1_Y,         DEVICE_READ,  DEVICE_OCU,     SYNC,    float )
   REGISTER( REG_JOYSTICK2_X,         DEVICE_READ,  DEVICE_OCU,     SYNC,    float )
   REGISTER( REG_JOYSTICK2_Y,         DEVICE_READ,  DEVICE_OCU,     SYNC,    float )
