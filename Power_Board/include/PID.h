...
/// @param controller_index, the index (0-based) of the controller on which to operate
/// @param y_desired the desired output value
/// @param y_actual the current, actual output value
/// @param x_nominal the nominal effort to acheive the desired output. Pass zero (0) if nominal
/// offset is NOT desired.
