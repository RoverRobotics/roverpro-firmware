...
/// Clear the contents and resize the ByteQueue. A new, empty buffer will be created in the heap.
...
bool bq_try_push(volatile ByteQueue *self, size_t n, void *data_in);
...
///         false if not enough bytes were present.
bool bq_try_pop(volatile ByteQueue *self, size_t n, void *data_out);
